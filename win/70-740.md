...
Exam skill quick reference

**<code>&nbsp;1.&nbsp;</code>** [<code>&nbsp;1&nbsp;</code>][1.1] [<code>&nbsp;2&nbsp;</code>][1.2] [<code>&nbsp;3&nbsp;</code>][1.3]\
**<code>&nbsp;2.&nbsp;</code>** [<code>&nbsp;1&nbsp;</code>][2.1] [<code>&nbsp;2&nbsp;</code>][2.2] [<code>&nbsp;3&nbsp;</code>][2.3]\
**<code>&nbsp;3.&nbsp;</code>** [<code>&nbsp;1&nbsp;</code>][3.1] [<code>&nbsp;2&nbsp;</code>][3.2] [<code>&nbsp;3&nbsp;</code>][3.3] [<code>&nbsp;4&nbsp;</code>][3.4]\
**<code>&nbsp;4.&nbsp;</code>** [<code>&nbsp;1&nbsp;</code>][4.1] [<code>&nbsp;2&nbsp;</code>][4.2]\
**<code>&nbsp;5.&nbsp;</code>** [<code>&nbsp;1&nbsp;</code>][5.1] [<code>&nbsp;2&nbsp;</code>][5.2] [<code>&nbsp;3&nbsp;</code>][5.3] [<code>&nbsp;4&nbsp;</code>][5.4] [<code>&nbsp;5&nbsp;</code>][5.5] [<code>&nbsp;6&nbsp;</code>][5.6]\
**<code>&nbsp;6.&nbsp;</code>** [<code>&nbsp;1&nbsp;</code>][6.1] [<code>&nbsp;2&nbsp;</code>][6.2]
...
- [Labs](#labs)
    ...
    - [Data deduplication](#data-deduplication-1)
    ...
    - [Hyperconverged failover cluster](#hyperconverged-failover-cluster)
...
Windows Server 2016 [Datacenter][Windows Server 2016 Datacenter] edition versus standard edition comparison:

|Standard|Datacenter|
|--|--|
|Core functionality|Core functionality|
|Unlimited containers|Unlimited containers|
...
Data deduplication, once [installed][Install-WindowsFeature], runs as a low-priority background process when the system is idle, by default; however its behavior can be [configured][Enable-DedupVolume] based on its intended usage.
...
[Failover clusters][failover cluster] are composed of computers called **nodes** which typically possess a secondary network adapter, used for cluster communications. 
They can be created using [`New-Cluster`][New-Cluster].
...
Microsoft defined two deployment scenarios for [Storage Spaces Direct (S2D)][S2D]: 
...
CPU counter | Acceptable values
--- | ---
[Processor: % Processor Time][Processor: % Processor Time] | &lt;85%
[Processor: Interrupts/Sec][Processor: Interrupts/Sec] | Baseline
...
Memory counter | Acceptable values
--- | ---
...
Disk counters | Acceptable values
--- | ---
[PhysicalDisk: Disk Bytes/Sec][PhysicalDisk: Disk Bytes/Sec] | Baseline
[PhysicalDisk: Avg. Disk Bytes/Transfer][PhysicalDisk: Avg. Disk Bytes/Transfer] | Baseline
...
Network counters | Acceptable values
--- | ---
[Network Interface: Bytes Total/Sec][Network Interface: Bytes Total/Sec] | Baseline
...
wdsutil /set-server /NewMachineNamingPolicy:PLABSA%#03
```
